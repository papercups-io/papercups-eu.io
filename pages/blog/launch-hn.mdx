...
export default ({children}) => (
  <Layout title="Launch HN: What We Learned">{children}</Layout>
);
...
_Check out our [demo](https://app.papercups-eu.io/demo), or [sign up for a free account](https://app.papercups-eu.io/register)!_
